        ...
        <div class="row">
            <div class="col-lg-12 col-12">             
                <div class="card card-info">
                    ...
                    <h3 class="card-title"><i class="fas fa-file"></i> Edit Kategori Upload</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="POST" action="/superadmin/setting/kategori/upload/edit/{{$data->id}}">
                        @csrf
                    <div class="card-body">
