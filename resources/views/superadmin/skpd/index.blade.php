...
<div class="row">
    <div class="col-md-12">
        <h4>SKPD KABUPATEN KAPUAS</h4>
        <div class="row">
            <div class="col-12">
              <a href="/superadmin/skpd/add" class="btn btn-sm btn-primary"><i class="fas fa-university"></i> Tambah SKPD</a> <br/><br/>
              <div class="card">
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      @foreach ($data as $key => $item)
                          <tr>
                            <td>{{$no++}}</td>
                            <td><img src="/theme/logo.png" width="40px"></td>
